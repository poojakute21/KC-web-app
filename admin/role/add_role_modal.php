...
<div class="modal-body">
  ...
  <input type="text" name="roleName" class="form-control" required pattern="[A-Za-z0-9]+" maxlength="50" title="Max 50 Character and Numbers allowed!">
  </br> 
  <label> Status : </label>
  <input type="radio" name="roleStatus" value="Y" required> Active </label>
  <input type="radio" name="roleStatus" value="N" required> Inactive </label>
  </br>
