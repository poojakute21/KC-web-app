...
<div class="modal-body">
  ...
  ?>
    ...
    <input type="text" name="documentName" class="form-control" value="<?php echo $document_details_row['name']; ?>" required pattern="[A-Za-z0-9]+" maxlength="50" title="Max 50 Character and Numbers allowed!">
    </br> 
    <label> Status : </label>
    <input type="radio" name="documentStatus" value="Y" required <?php echo ($document_details_row['status'] == "Y") ? 'checked' : '' ; ?> > Active </label>
    <input type="radio" name="documentStatus" value="N" required <?php echo ($document_details_row['status'] == "N") ? 'checked' : '' ; ?> > Inactive </label>
    </br>
